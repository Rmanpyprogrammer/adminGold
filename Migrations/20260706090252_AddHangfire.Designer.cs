...
namespace Core.API.Migrations
{
    ...
    [Migration("20260706090252_AddHangfire")]
            ...
            modelBuilder.Entity("Core.API.Models.Invoice", b =>
                {
                    ...
                    b.Property<int>("DigikalaId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_Orders_CreatedAt_BRIN");
            ...
            modelBuilder.Entity("Core.API.Models.InvoiceProduct", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DigikalaId"));
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_Orders_CreatedAt_BRIN_product");
